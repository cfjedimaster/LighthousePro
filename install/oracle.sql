...
(
  ...
  DEFAULTLOCUS VARCHAR2(35 BYTE) NULL,
  DEFAULTSEVERITY VARCHAR2(35 BYTE) NULL,
  DEFAULTISSUETYPE VARCHAR2(35 BYTE) NULL,
  DEFAULTSTATUS VARCHAR2(35 BYTE) NULL, 
...
(
ID            VARCHAR2(35 BYTE)  NOT
NULL,
 NAME          VARCHAR2(255 BYTE)
NOT NULL,
 DUEDATE       DATE
DEFAULT sysdate NOT NULL,
PROJECTIDFK   VARCHAR2(35 BYTE)  NOT
NULL,
 CONSTRAINT PK_LH_MILESTONES
PRIMARY KEY (ID)
);
...
USERIDFK VARCHAR2(35 BYTE) NULL,
PROJECTIDFK VARCHAR2(35 BYTE) NULL,
ISSUETYPEIDFK VARCHAR2(35 BYTE) NULL,
PROJECTLOCUSIDFK VARCHAR2(35 BYTE) NULL,
SEVERITYIDFK VARCHAR2(35 BYTE) NULL,
STATUSIDFK VARCHAR2(35 BYTE) NULL,
ASSIGNEDUSERIDFK VARCHAR2(35 BYTE) NULL,
MILESTONEIDFK VARCHAR2(35 BYTE) NULL,
KEYWORDFILTER VARCHAR2(355 BYTE) NULL,
RESULTCOUNT PLS_INTEGER NULL,
CONSTRAINT PK_LH_FILTERS 
PRIMARY KEY(ID)
);
