...
<dl>
	...
	<dt>Due Date:</dt>
	<dd><cfif len(issueBean.getDueDate())>#dateFormat(issueBean.getDueDate(), variables.dateformat)#</cfif><cfif isDefined("arguments.oldBean") and len(oldduedate)> was #dateFormat(oldduedate, "m/d/yy")#</cfif></dd>
	<dt>Type:</dt>
	...
	<dt>Created:</dt>
	<dd>#dateFormat(issueBean.getCreated(),variables.dateformat)# #timeFormat(issueBean.getCreated(),"h:mm tt")#</dd>
	<dt>Updated:</dt>
	<dd>#dateFormat(issueBean.getUpdated(),variables.dateformat)# #timeFormat(issueBean.getUpdated(),"h:mm tt")#</dd>
	<dt>Owner:</dt>
